...
--Presidenti:
INSERT INTO Presidenti(cf, nome, cognome, password)
VALUES("DLRRLA49E24H501B", 'Aurelio', 'De Laurentiis', MD5('qwerty1'));

INSERT INTO Presidenti(cf, nome, cognome, password)
VALUES("GNLNDR75T06L219C", 'Andrea', 'Agnelli', MD5('qwerty2'));
...
--Dirigenti:
INSERT INTO Dirigenti(cf, nome, cognome, id_societa, password)    
VALUES('GNTMNL06M01G633L', 'Emanuele', 'Gentile', '1',  MD5('qwerty3'));

INSERT INTO Dirigenti(cf, nome, cognome, id_societa, password)
VALUES('RSSYRU06B12E512W', 'Yuri', 'Rossi', '2',  MD5('qwerty4'));
